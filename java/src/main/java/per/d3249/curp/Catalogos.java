...
public class Catalogos {
    ...
    public static final String[] ARRAY_PRIMEROS_NOMBRES_IGNORADOS = { "MARIA", "MA.", "MA", "JOSE", "J", "J.", "DA",
            "DAS", "DE", "DEL", "DER", "DI", "DIE", "DD", "EL", "LA", "LOS", "LAS", "LE", "LES", "MAC", "MC", "VAN",
            "VON", "Y" };

    public static final String[] ARRAY_PALABRAS_IMPROPIAS = { "BACA", "BAKA", "BUEI", "BUEY", "CACA", "CACO", "CAGA",
    ...
    public static final List<String> LISTA_PRIMEROS_NOMBRES_IGNORADOS = Arrays.asList(ARRAY_PRIMEROS_NOMBRES_IGNORADOS);
    public static final List<String> LISTA_PALABRAS_IMPROPIAS = Arrays.asList(ARRAY_PALABRAS_IMPROPIAS);
